...
export default function Footer() {
  return (
    <footer className="bg-[#f6d4c2] text-white text-center p-4">
      <div className="flex w-full sm:max-w-6xl  mx-auto  p-9">


<div className="block sm:hidden">
        <div className="w-1/2 sd:w-1/3 flex flex-col items-center text-center">
        ...
        <div className="w-1/2 sm:w-1/3 pl-20 pt-0">
